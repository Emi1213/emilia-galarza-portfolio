import type { AboutMe } from "../../features/about/types/about.interface";
...
export const ABOUT_ME_DATA: AboutMe[] = [
  ...
  },
  {
    ...
    description:
      "I approach every project with a user-first mindset, ensuring that functionality and aesthetics work in perfect harmony. Clean, maintainable code is my foundation, while continuous learning keeps me at the forefront of web technologies. I believe in writing code that not only works today but stands the test of time.",
  },
  {
    title: "Technical Expertise",
    description:
      "Specialized in modern JavaScript frameworks like React, Vue.js, and Angular, with expertise in responsive design, performance optimization, and cross-browser compatibility. I'm proficient in TypeScript, Node.js, and have experience with various build tools and deployment strategies. Always staying updated with the latest web standards and best practices.",
    tags: ["React", "TypeScript", "Node.js", "Performance", "Responsive Design"]
  },
  {
  ...
  },
  {
    ...
    description:
      "Self-taught developer with a formal background in design, constantly expanding my knowledge through online courses, workshops, and hands-on projects. I'm a firm believer in lifelong learning and regularly challenge myself with new technologies and methodologies to stay ahead in this ever-evolving field.",
    tags: ["Self-taught", "Continuous Learning", "Workshops", "Growth Mindset"]
  },
  {
  ...
  },
  {
    ...
    description:
      "I thrive in collaborative environments where diverse minds come together to solve complex problems. Whether working with designers, backend developers, or product managers, I believe in transparent communication, shared ownership, and celebrating collective achievements. Great products are built by great teams.",
  }
];
